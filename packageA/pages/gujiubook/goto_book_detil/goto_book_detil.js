  ...
  onShareAppMessage: function (res) {
    ...
    if (res.from === 'button') {
      ...
      return {
        ...
        imageUrl: imageUrl,
        path: '/packageA/pages/gujiubook/goto_book_detil/goto_book_detil?id=' + id,
...
get_book_detail(){
  ...
  common.get('/newhome/old_book_detail',{
    id,
    member_id
  }).then(res =>{
    if(res.data.code ==200){
      ...
      that.setData({
          book_info:res.data.data[0],
          stock:res.data.data[0].stock,
          summary_image:res.data.data[0].imgs,
          title,
      })
...
subimt_buy(e) {
  ...
  if (!member_id) {
    ...
    wx.setStorageSync('book_info3', new_book_info);
    wx.navigateTo({
      url: '/packageA/pages/gujiubook/memberorder/index?pay_money=' + pay_money + '&number=' + number,
    })
},
see_quanbu(){
